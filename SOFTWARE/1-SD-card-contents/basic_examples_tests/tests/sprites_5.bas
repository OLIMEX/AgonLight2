 ...
 1170 VDU 23,1,0
 1180 :
 1190 REM Move the sprite
 1200 :
 1210 *FX 19
 1220 GCOL 0,16+RND(64)
 1230 PLOT &40,1279,RND(1024)
 1240 VDU 23,7,0,1,1
 1250 CALL code
 1260 GOTO 1210
 1270 :
 ...
 1300 REM N% - Bitmap number
 1310 REM W% - Bitmap width
 1320 REM H% - Bitmap height
 1330 :
 1340 DEF PROCloadSprite(F$,N%,W%,H%)
 1350 OSCLI("LOAD " + F$ + " " + STR$(MB%+graphics))
 1360 VDU 23,27,0,N%
 1370 VDU 23,27,1,W%;H%;
 1380 FOR I%=0 TO (W%*H%*3)-1 STEP 3
 1390   VDU 255
 1400   VDU ?(graphics+I%+2)
 1410   VDU ?(graphics+I%+1)
 1420   VDU ?(graphics+I%+0)
 1430 NEXT
 1440 ENDPROC
